...
| Technical quality | Pure domain boundary, live/fake adapter parity, marketId isolation, bounded write and confirmation paths | `src/exchange/port.ts`; 397-test suite; `src/ui/App.integration.test.tsx`; `docs/VERIFICATION.md` |
