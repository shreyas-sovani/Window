...
- **README + brand (2026-09-08, this session):** `docs/brand/logo.png` (480×480 mark) plus SMIL SVGs (`lock-ring`, `tagline`, `flow`) on the root README. YouTube live. Live HTTPS still PENDING. `submission.md` uses the same mark; DoraHacks live URL still `REPLACE_WITH_LIVE_URL`.
